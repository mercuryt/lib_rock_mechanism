...
FindPathResult TerrainFacade::findPathBreadthFirstWithoutMemo(const BlockIndex& start, const Facing4& startFacing, DestinationConditionT& destinationCondition, const ShapeId& shape, const MoveTypeId& moveType, bool detour, bool adjacent, const FactionId& faction, const DistanceInBlocks& maxRange) const
{
...
template<bool anyOccupiedBlock, DestinationCondition DestinationConditionT>
FindPathResult TerrainFacade::findPathDepthFirstWithoutMemo(const BlockIndex& from, const Facing4& startFacing, DestinationConditionT& destinationCondition, const BlockIndex& huristicDestination, const ShapeId& shape, const MoveTypeId& moveType, bool detour, bool adjacent, const FactionId& faction, const DistanceInBlocks& maxRange) const
{
	auto& hasMemos = m_area.m_simulation.m_hasPathMemos;
...
template<bool anyOccupiedBlock, DestinationCondition DestinationConditionT>
FindPathResult TerrainFacade::findPathToConditionBreadthFirst(DestinationConditionT destinationCondition, PathMemoBreadthFirst& memo, const BlockIndex& start, const Facing4& startFacing, const ShapeId& shape, bool detour, bool adjacent, const FactionId& faction, const DistanceInBlocks& maxRange) const
{
...
template<bool anyOccupiedBlock, DestinationCondition DestinationConditionT>
FindPathResult TerrainFacade::findPathToConditionBreadthFirstWithoutMemo(DestinationConditionT& destinationCondition, const BlockIndex& start, const Facing4& startFacing, const ShapeId& shape, bool detour, bool adjacent, const FactionId& faction, const DistanceInBlocks& maxRange) const
{
...
FindPathResult TerrainFacade::findPathToBlockDesignationAndCondition(DestinationConditionT& destinationCondition, PathMemoBreadthFirst& memo, const BlockDesignation designation, FactionId faction, const BlockIndex& start, const Facing4& startFacing, const ShapeId& shape, bool detour, bool adjacent, bool unreserved, const DistanceInBlocks& maxRange) const
{
	...
	auto designationCondition = [&hasBlockDesginationsForFaction, designation, destinationCondition](const BlockIndex& block, const Facing4& facing) -> std::pair<bool, BlockIndex>
	{
