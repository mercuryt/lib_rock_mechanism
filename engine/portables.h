...
public:
	...
	void reservable_merge(const Index index, Reservable& other);
	...
	void onDeck_erasePointsContainingFluid(const Index index, const CuboidSet& points) { m_cuboidsContainingFluidOnDeck[index].maybeRemoveAll(points); }
