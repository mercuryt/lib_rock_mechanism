...
struct Point3D
{
	...
	[[nodiscard]] GDB_CALLABLE static Point3D createDbg(const DistanceWidth& x, const DistanceWidth& y, const DistanceWidth& z);
...
struct Offset3D
{
	...
	[[nodiscard]] GDB_CALLABLE static Offset3D createDbg(const OffsetWidth& x, const OffsetWidth& y, const OffsetWidth& z);
...
[[nodiscard]] GDB_CALLABLE Offset3D createOffset(const OffsetWidth& x, const OffsetWidth& y, const OffsetWidth& z);
[[nodiscard]] GDB_CALLABLE Point3D createPoint(const DistanceWidth& x, const DistanceWidth& y, const DistanceWidth& z);