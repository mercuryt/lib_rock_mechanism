...
void PsycologyData::addTo(const PsycologyAttribute& attribute, const PsycologyWeight& value) { m_data[(int32_t)attribute] += value.get(); }
void PsycologyData::set(const PsycologyAttribute& attribute, const PsycologyWeight& value) { m_data[(int32_t)attribute] = value.get(); }
void PsycologyData::setAllToZero() { m_data = 0; }
const PsycologyWeight PsycologyData::getValueFor(const PsycologyAttribute& attribute) const { return {m_data[(int32_t)attribute]}; }
