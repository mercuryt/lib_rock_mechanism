...
struct AttackType
{
	...
	AttackType(std::string n, uint32_t a, Force bf, DistanceInBlocksFractional r, CombatScore cs, Step cd, bool p, const WoundType wt, const SkillType& st, const ItemType* pit) :
