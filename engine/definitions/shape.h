...
public:
	...
	[[nodiscard]] static MapWithOffsetCuboidKeys<CollisionVolume> applyOffsetAndRotationAndSubtractOriginal(const ShapeId shape, const Offset3D offset, const Facing4 initialFacing, const Facing4 newFacing);
