...
struct ItemTypeParamaters final
{
	...
	std::string name;
	std::array<int, 3> craftLocationOffset = {};
	ShapeId shape;
	MoveTypeId moveType;
	...
	int wearable_defenseScore = 0;
	int wearable_layer = 0;
	int wearable_bodyTypeScale = 0;
	int wearable_forceAbsorbedUnpiercedModifier = 0;
	int wearable_forceAbsorbedPiercedModifier = 0;
...
class ItemType final
{
	...
	StrongVector<std::array<int, 3>, ItemTypeId> m_craftLocationOffset;
	...
	StrongVector<int, ItemTypeId> m_value;
	...
	StrongVector<int, ItemTypeId> m_wearable_defenseScore;
	StrongVector<int, ItemTypeId> m_wearable_layer;
	StrongVector<int, ItemTypeId> m_wearable_bodyTypeScale;
	StrongVector<int, ItemTypeId> m_wearable_forceAbsorbedUnpiercedModifier;
	StrongVector<int, ItemTypeId> m_wearable_forceAbsorbedPiercedModifier;
...
public:
	...
	[[nodiscard]] static std::array<int, 3>& getCraftLocationOffset(const ItemTypeId& id);
	...
	[[nodiscard]] static int getValue(const ItemTypeId& id);
	...
	[[nodiscard]] static int getWearable_defenseScore(const ItemTypeId& id);
	[[nodiscard]] static int getWearable_layer(const ItemTypeId& id);
	[[nodiscard]] static int getWearable_bodyTypeScale(const ItemTypeId& id);
	[[nodiscard]] static int getWearable_forceAbsorbedUnpiercedModifier(const ItemTypeId& id);
	[[nodiscard]] static int getWearable_forceAbsorbedPiercedModifier(const ItemTypeId& id);
