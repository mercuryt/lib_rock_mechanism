...
class AnimalSpecies
{
	...
	StrongVector<std::array<int, 3>, AnimalSpeciesId> m_height;
	...
	StrongVector<int, AnimalSpeciesId> m_bodyScale;
...
public:
	...
	[[nodiscard]] static std::array<int, 3> getHeight(const AnimalSpeciesId& id);
	...
	[[nodiscard]] static int getBodyScale(const AnimalSpeciesId& id);
