...
std::tuple<Cuboid, RTreeBoolean::ArrayIndex, RTreeBoolean::ArrayIndex> RTreeBoolean::findPairWithLeastNewVolumeWhenExtended(const CuboidArray<nodeSize + 1>& cuboids)
{
...
SmallSet<Cuboid> RTreeBoolean::gatherLeavesRecursive(const Index& parent)
{
...
void RTreeBoolean::clearAllContained(Node& parent, const Cuboid& cuboid)
{
	const auto& parentCuboids = parent.getCuboids();
