...
template<typename T, int capacity>
int LimitedSet<T, capacity>::indexOf(const T& value) const
{
...
template<typename T, int capacity>
int LimitedSet<T, capacity>::size() const { return m_size; }
template<typename T, int capacity>
...
template<typename T, int capacity>
int LimitedSet<T, capacity>::findLastIndex(const T& value) const
{
