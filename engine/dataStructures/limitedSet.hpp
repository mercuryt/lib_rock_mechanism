...
template<typename T, int32_t capacity>
void LimitedSet<T, capacity>::eraseIndex(const int32_t& index) { erase(begin() + index); }
template<typename T, int32_t capacity>
...
template<typename T, int32_t capacity>
const T& LimitedSet<T, capacity>::operator[](const int32_t& index) const { assert(index < m_size); return m_data[index]; }
template<typename T, int32_t capacity>
T& LimitedSet<T, capacity>::operator[](const int32_t& index) { assert(index < m_size); return m_data[index]; }
template<typename T, int32_t capacity>
...
template<typename T, int32_t capacity>
int32_t LimitedSet<T, capacity>::indexOf(const T& value) const
{
...
template<typename T, int32_t capacity>
int32_t LimitedSet<T, capacity>::size() const { return m_size; }
template<typename T, int32_t capacity>
...
template<typename T, int32_t capacity>
int32_t LimitedSet<T, capacity>::findLastIndex(const T& value) const
{
