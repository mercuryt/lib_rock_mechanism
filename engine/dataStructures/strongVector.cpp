...
template class std::vector<int8_t>;
...
template class StrongVector<Faction, FactionId>;
...
template class StrongVector<std::array<int32_t, 3>, AnimalSpeciesId>;
...
template class StrongVector<int16_t, PlantSpeciesId>;
template class StrongVector<int32_t, AnimalSpeciesId>;
template class StrongVector<int32_t, AttackTypeId>;
template class StrongVector<int32_t, FluidTypeId>;
template class StrongVector<int32_t, ItemTypeId>;
template class StrongVector<int32_t, MaterialTypeId>;
template class StrongVector<int32_t, ShapeId>;
template class StrongVector<int8_t, MoveTypeId>;
template class StrongVector<int8_t, PlantSpeciesId>;
