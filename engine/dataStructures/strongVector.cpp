...
template class std::vector<std::array<int, 3>>;
...
template class StrongVector<std::array<int, 3>, ItemTypeId>;
template class StrongVector<std::array<int, 3>, AnimalSpeciesId>;
...
template class StrongVector<int, PlantSpeciesId>;
template class StrongVector<int, AnimalSpeciesId>;
template class StrongVector<int, AttackTypeId>;
template class StrongVector<int, FluidTypeId>;
template class StrongVector<int, ItemTypeId>;
template class StrongVector<int, MaterialTypeId>;
template class StrongVector<int, ShapeId>;
