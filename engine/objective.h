...
enum class ObjectiveTypeId { Construct, Craft, Dig, Drink, Eat, Equip, GetToSafeTemperature, GivePlantsFluid, GoTo, Harvest, Haul, InstallItem, Kill, LeaveArea, Medical, Rest, Sleep, Station, SowSeeds, StockPile, Uniform, Wait, Wander, WoodCutting };
