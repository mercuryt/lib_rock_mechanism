...
using TemperatureSourceIdWidth = int32_t;
class TemperatureSourceId : public StrongInteger<TemperatureSourceId, TemperatureSourceIdWidth, INT32_MAX, 0>
{
public:
	struct Hash { [[nodiscard]] size_t operator()(const TemperatureSourceId index) const { return index.get(); } };
};
