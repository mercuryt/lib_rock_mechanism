...
TEST_CASE("craft")
{
	...
	SUBCASE("craft bucket")
	{
		...
		{
			areaBuilderUtil::setSolidWall(area.m_blocks[0][3][1], area.m_blocks[9][3][1], wood);
		...
		SUBCASE("worker dies")
		{
			...
			Actor& dwarf2 = simulation.createActor(AnimalSpecies::byName("dwarf"), area.m_blocks[1][5][1]);
