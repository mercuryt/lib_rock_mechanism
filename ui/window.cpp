				...
				case sf::Event::KeyPressed:
					...
					{	
						...
						case sf::Keyboard::PageDown:
							...
							break;
						case sf::Keyboard::Up:
							if(m_view.getCenter().y > (m_view.getSize().y / 2) - 10)
								m_view.move(0.f, scrollSteps * -20.f);
							break;
						case sf::Keyboard::Down:
							if(m_view.getCenter().y < m_area->m_sizeY * m_scale - (m_view.getSize().y / 2) + 10)
								m_view.move(0.f, scrollSteps * 20.f);
							break;
						case sf::Keyboard::Left:
							if(m_view.getCenter().x > (m_view.getSize().x / 2) - 10)
								m_view.move(scrollSteps * -20.f, 0.f);
							break;
						case sf::Keyboard::Right:
							if(m_view.getCenter().x < m_area->m_sizeX * m_scale - (m_view.getSize().x / 2) + 10)
								m_view.move(scrollSteps * 20.f, 0.f);
							break;
