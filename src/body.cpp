...
Body::Body(const BodyType& bodyType) : m_totalVolume(0), m_impairMovePercent(0), m_impairManipulationPercent(0)
{
...
void Body::healWound(Wound& wound, BodyPart& bodyPart)
{
