...
SowSeedsEvent::SowSeedsEvent(Step delay, SowSeedsObjective& o, const Step start) : ScheduledEventWithPercent(o.m_actor.getSimulation(), delay, start), m_objective(o) { }
