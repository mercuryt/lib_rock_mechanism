...
enum class ObjectiveId { Construct, Craft, Dig, Drink, Eat, GetToSafeTemperature, GivePlantsFluid, Harvest, Haul, Kill, Rest, Sleep, Station, SowSeeds, StockPile, Wait, Wander };
