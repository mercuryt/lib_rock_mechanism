...
public:
	...
	void insert(const Faction& f, const BlockDesignation& bd){ m_designations[&f].insert(bd); }
	void remove(const Faction& f, const BlockDesignation& bd){ m_designations[&f].erase(bd); }
};
