...
public:
	...
	VisionCuboid<DerivedBlock, Area>* m_visionCuboid;
	...
	BaseBlock();
	DerivedBlock& derived() { return static_cast<DerivedBlock&>(*this); }
	const DerivedBlock& const_derived() const { return static_cast<const DerivedBlock&>(*this); }
